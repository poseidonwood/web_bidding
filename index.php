...
<head>
  ...
  <title>Monitoring Server - Tool Untuk Pantau Server</title>
...
<body class="body-scroll d-flex flex-column h-100 menu-overlay" data-page="homepage">
    ...
    <div class="row h-100">
      <div class="align-self-center col">
        <div class="logo-loading">
          ...
          <h4 class="text-default">Monitoring Server</h4>
          <p class="text-secondary">Tool Untuk Pantau Server</p>
  ...
  <div class="main-menu">
    ...
    <div class="menu-container">
      <div class="row mb-4">
        ...
        <div class="col-auto">
          <button class="btn btn-default btn-40 rounded-circle" data-toggle="modal" data-target="#addmoney">
      ...
      <div class="row">
        ...
        <div class="text-left col align-self-center">
          <a class="navbar-brand" href="#">
            <h5 class="mb-0">Monitoring Server</h5>
          </a>
        </div>
      ...
      <div class="row text-center mt-3">
        <div class="col-6 col-md-3">
          <div class="card border-0 mb-4">
            <div class="card-body">
              <p class="font-weight-normal">REALTIME</p>
              <div class="avatar avatar-60 bg-default-light rounded-circle text-default">
                <i class="material-icons vm md-36 text-template">trending_up</i>
              </div>
              <p class="mt-3 mb-0 font-weight-normal">ULIRUNGKUT</p>
              <p class="mt-3 mb-0 font-weight-normal" style="color:green;">⬆️ SERVER UP</p>
              <p class="text-secondary small">2020-11-21 19:02:02</p>
            </div>
          </div>
        </div>
        <div class="col-6 col-md-3">
          <div class="card border-0 mb-4">
            <div class="card-body">
              <p class="font-weight-normal">REALTIME</p>
              <div class="avatar avatar-60 bg-default-light rounded-circle text-default">
                <i class="material-icons vm md-36 text-template">trending_down</i>
              </div>
              <p class="mt-3 mb-0 font-weight-normal">NGIRIMWA</p>
              <p class="mt-3 mb-0 font-weight-normal" style="color:red;">⬇️ SERVER DOWN</p>
              <p class="text-secondary small">2020-11-21 19:02:02</p>
            </div>
          </div>
        </div>
        <div class="col-6 col-md-3">
          <div class="card border-0 mb-4">
            <div class="card-body">
              <p class="font-weight-normal">LAST DOWN</p>
              <div class="avatar avatar-60 bg-default-light rounded-circle text-default">
                <i class="material-icons vm md-36 text-template">trending_down</i>
              </div>
              <p class="mt-3 mb-0 font-weight-normal">ULIRUNGKUT</p>
              <p class="mt-3 mb-0 font-weight-normal" style="color:red;">⬇️ LAST DOWN</p>
              <p class="text-secondary small">2020-11-21 19:02:02</p>
            </div>
          </div>
        </div>
    ...
    <div class="main-container">
        ...
        <div class="card">
          <div class="card-body text-center">
            ...
            <button class="btn btn-sm btn-outline-secondary rounded" id="more-expand-btn">
              Show more
              <span class="ml-2 small material-icons">expand_more</span>
            </button>
      ...
      <div class="container mb-4">
        <div class="row">
          ...
          <div class="col-auto">
            <a href="" class="text-default">View all</a>
          </div>
        </div>
        <div class="row">
          ...
          <div class="card-body text-center">
            <div class="row mb-3">
              <div class="col-10 col-md-4 mx-auto">
                <img src="img/install-app.png" alt="" class="mw-100" />
              </div>
            </div>

            <h5 class="text-dark">
              Add to <span class="font-weight-bold">Home screen</span>
            </h5>
            <p class="text-secondary">
              See PWA app as in fullscreen on your device.
            </p>
            <button class="btn btn-sm btn-default px-4 rounded" id="addtohome">
              Install
            </button>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-secondary small">
              Open menu after selecting style
            </p>
            <div class="row">
      ...
      <div class="container mb-4">
        <div class="card">
          <div class="card-body text-left text-md-center">
            ...
            <h4 class="mb-3">
              Finance is not only income and expense. Its about more than
              that.
            </h4>
            <h4 class="text-secondary font-weight-normal">
              We are at our best
            </h4>
            <div class="row my-3 justify-content-center">
              <div class="col-10 col-md-4 mx-auto">
                <img src="img/about.png" alt="" class="mw-100" />
              </div>
            </div>
            <p class="text-secondary mt-3">
              User experienced user interfaces with HTML and CSS also
              providing flexibility of style color customization. We have
              created specific website template demos and component library
              which be used across any demo.
            </p>
  ...
  <div class="color-picker">
    <div class="row">
      ...
      <div class="col-auto">
        <button class="btn btn-link text-secondary btn-round colorsettings2">
